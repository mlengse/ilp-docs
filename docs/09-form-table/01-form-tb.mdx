...
<table style={{width:'100%'}}>
    <tr style={{width:'100%'}}>
        <td colSpan={4}>**IDENTITAS DIRI PESERTA**</td>
    </tr>
    ...
    <tr>
        ...
        <td>: ...../...../.....</td><td>Usia: </td><td style={{textAlign:'end'}}>tahun</td>
    </tr>   
    <tr>
        <td>**Jenis Kelamin**</td>
        
         <td colSpan={3}>
            <td style={{width:'50%'}}>Laki-laki</td> <td>Perempuan</td>
         </td>
    ...
    <tr>
        <td colSpan={4}>**PEMERIKSAAN BERAT BADAN DAN TINGGI BADAN**</td>
    </tr>
