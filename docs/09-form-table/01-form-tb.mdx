...
<table style={{width:'100%'}}>
    ...
    <tr><td colSpan={2}>Pernah terdiagnosa/ berobat TBC</td> <td colSpan={2}>Ya, kapan? .</td> <td colSpan={2}>Tidak</td></tr>
    
    <tr><td colSpan={2}>Pernah berobat TBC tapi pernah tidak tuntas</td> <td colSpan={2}>Ya</td> <td colSpan={2}>Tidak</td></tr>
    
    <tr><td colSpan={2}>Malnutrisi</td> <td colSpan={2}>Ya</td> <td colSpan={2}>Tidak</td></tr>
    
    <tr><td colSpan={2}>Merokok /Perokok Pasif</td> <td colSpan={2}>Ya</td> <td colSpan={2}>Tidak</td></tr>
    
    <tr><td colSpan={2}>Riwayat DM/Kencing Manis</td> <td colSpan={2}>Ya</td> <td colSpan={2}>Tidak</td></tr>
    
    <tr><td colSpan={2}>ODHIV</td> <td colSpan={2}>Ya</td> <td colSpan={2}>Tidak</td></tr>
    
    <tr><td colSpan={2}>Lansia > 65 tahun</td> <td colSpan={2}>Ya</td> <td colSpan={2}>Tidak</td></tr>
    
    <tr><td colSpan={2}>Ibu Hamil (Tidak direkomendasikan untuk pemeriksaan Skrining X-Ray)</td> <td colSpan={2}>Ya</td> <td colSpan={2}>Tidak</td></tr>
    
    <tr><td colSpan={2}>Warga Binaan Pemasyarakatan (WBP)</td> <td colSpan={2}>Ya</td> <td colSpan={2}>Tidak</td></tr>
    
    <tr><td colSpan={2}>Tinggal diwilayah padat kumuh miskin</td> <td colSpan={2}>Ya</td> <td colSpan={2}>Tidak</td></tr>
